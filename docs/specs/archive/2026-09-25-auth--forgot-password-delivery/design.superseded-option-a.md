> # ⚠️ SUPERSEDED — retained unedited as judgment-day's audit target
>
> This is the **Option A** (`CustomEmailSender`) design. Two blind judges reviewed it
> on 2026-09-22 and agreed on **14 findings, zero contradictions** — see `judgment.md`.
> Three were consequences of Option A itself rather than of how the design was written,
> so the route was re-opened (`proposal.md` §12, revised) and **Option B** was chosen.
>
> **It is kept byte-unedited on purpose.** `judgment.md` cites this document by section
> and line; rewriting it would leave that ledger describing a document that no longer
> exists. The current design is `design.md`.
