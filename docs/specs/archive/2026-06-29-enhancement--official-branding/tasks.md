...
- [x] T-1 Prepare brand logo assets  (deps: none)
...
- [x] T-2 Swap primary token ramp to Royal Blue  (deps: none)
...
- [x] T-3 Header — official colour logo  (deps: T-1)
...
- [x] T-4 Footer — white-reverse logo  (deps: T-1)
...
- [x] T-5 Favicon / app icons → Royal-Blue mark  (deps: none)
...
- [x] T-6 Update constitutional palette docs  (deps: T-2)
...
- [x] T-7 Brand QA + verification sweep  (deps: T-2, T-3, T-4, T-5, T-6)
