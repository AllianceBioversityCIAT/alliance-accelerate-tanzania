...
- [ ] **T-11 `lib/api/registrations-admin.ts` — typed client** (deps: T-4, T-6, T-7, T-8, T-9)
...
- [ ] **T-13 Detail page + `RegistrationDetailPanel`, `ConsentRecordCard`, `ActivityTrail`, `DuplicateWarningCard` (display)** (deps: T-11)
