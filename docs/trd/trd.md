...
| `POST /api/v1/contact` | Public | Stateless relay to the current Cognito `admin` group (or `CONTACT_FALLBACK_RECIPIENT`), never persisted. Always `202`, empty body. |
