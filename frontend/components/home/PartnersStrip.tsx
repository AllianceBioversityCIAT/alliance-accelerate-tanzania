...
//
// Maps over PARTNERS (lib/content/partners.ts) and groups them into three
// labeled tiers: "Funded by" (bmgf), "Led by" (alliance, pabra),
// "In partnership with" (tari, tosci, cimmyt).
//
