        ...
        <header className="sticky top-0 z-40 bg-surface border-b border-border shadow-sm">
          <div className="flex h-14 items-center justify-between gap-4 px-4 sm:px-6">
            ...
            >
              ...
              <svg aria-hidden="true" className="hidden h-3.5 w-3.5 text-muted sm:block" viewBox="0 0 16 16" fill="currentColor">
            ...
            <h2 className="hidden shrink-0 text-xs font-semibold uppercase tracking-widest text-muted sm:block sm:text-sm">
              Admin console
            </h2>
          </div>
        </header>
